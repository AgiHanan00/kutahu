                ...
                <div class="row">
                    <div class="">
                        ...
                        <div class="col-12 d-md-flex justify-content-between">
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/uqzPk3Sc4Xo?si=7V0b5eNUPogJNlUj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                            <img src="{{ asset('image/kutahulogo (2).png') }}" class="col-md-4" height="250" alt="">
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/nuiMYqMrEf0?si=LU0BW96L-gqliK-x" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
